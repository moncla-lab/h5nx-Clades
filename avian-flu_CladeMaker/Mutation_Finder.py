...
#output_file_path = "unique_clades.txt" ----- not working yet
...
"""
def pretty_print(alluniqueHA, alluniqueNuc):

    print("Here are your unique HA mutations:")
    for key in alluniqueHA.keys():
        print(f"Clade: {key}")
        print(f"Mutations: ")
        print(alluniqueHA[key])
        print("\n")

    print("Here are your unique nucleotide mutations:")
    for key in alluniqueNuc.keys():
        print(f"Clade: {key}")
        print(f"Mutations: ")
        print(alluniqueNuc[key])
        print("\n")
    return None
...
test = node_finder(nodeClades, hierarchy)
print(test)