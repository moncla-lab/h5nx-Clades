...
Input_File_Path = "h5nX_ha.fa" #file where the unformatted sequences are held
Output_File_Path_Nextstrain = "h5n1_ha.fasta" #new file with properly formatted lines
